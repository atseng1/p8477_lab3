...
parameters.SIR = c(beta, gamma) # ASSEMBLE YOUR PARAMETER SET FOR EACH MODEL
parameters.SIRdem = c(beta, gamma, mu) # ASSEMBLE YOUR PARAMETER SET FOR EACH MODEL
...
plot(sim.SIR[,'time'],i.SIR,ylab='% I',xlab='Time (day)', type='l',col='red',lwd=1)
...
plot(sim.SIRdem[,'time'],s.SIRdem,ylab='% S',xlab='Time',xlim=c(1,365*10), 
     type='l',col='blue')
plot(sim.SIRdem[,'time'],i.SIRdem,ylab='% I',xlab='Time',xlim=c(1,365*100),
     type='l',col='red')

plot(sim.SIR[,'time'],i.SIR,ylab='% I',xlab='Time',xlim=c(1,365*100),
     type='l',col='red')
